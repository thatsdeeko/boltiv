(function(){
  window.boltivGetTransactionPin = function(){
    return new Promise(function(resolve){
      ...
      modal.innerHTML=`<div class="boltiv-pin-card"><div class="boltiv-pin-icon">🔐</div><div class="boltiv-pin-title">Enter Transaction PIN</div><div class="boltiv-pin-message">Enter your 4-digit transaction PIN to confirm this purchase.</div><input id="boltivPinInput" class="boltiv-pin-input" type="password" inputmode="numeric" maxlength="4" autocomplete="one-time-code" placeholder="••••"><div class="boltiv-pin-actions"><button id="boltivPinCancel" type="button">CANCEL</button><button id="boltivPinConfirm" type="button">CONFIRM</button></div><div id="boltivPinError" class="boltiv-pin-error"></div></div>`;
